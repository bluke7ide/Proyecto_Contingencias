...
### Observaciones
```{r}
proy_hombres$proy_ben_emp <- round(proy_ben_emp(proy_hombres),2)
proy_mujeres$proy_ben_emp <- round(proy_ben_emp(proy_mujeres),2)
```

## Proyección del VP de los pagos de beneficio de muerte de pensionado
```{r}
proy_ben_pen <- function(df){
  col <- df[[7]]
  for (i in 1:100){
...
### Observaciones
```{r}
proy_hombres$proy_ben_pen <- round(proy_ben_pen(proy_hombres),2)
proy_mujeres$proy_ben_pen <- round(proy_ben_pen(proy_mujeres),2)
```

## Proyección de los pagos de beneficio de anualidades
```{r}
proy_ben_ann <- function(df){
  col <- df[[5]]
  interes <- 1.07^(1/12) - 1
...
### Observaciones
```{r}
proy_hombres$proy_ben_ann <- round(proy_ben_ann(proy_hombres),2)
proy_mujeres$proy_ben_ann <- round(proy_ben_ann(proy_mujeres),2)
```
