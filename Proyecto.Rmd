...
#proy_emp$poblacionM <- floor(proy_emp$poblacionM)
#proy_emp$poblacionH <- floor(proy_emp$poblacionH)
```
...
# proy_pen$poblacionM <- floor(proy_pen$poblacionM)
# proy_pen$poblacionH <- floor(proy_pen$poblacionH)
```


```{r}
proy_death_emp <- proy_emp
```
