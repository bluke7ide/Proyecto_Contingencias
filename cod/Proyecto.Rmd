...
ggplot() +
  geom_line(data = proy_hombres,
            aes(x = año, y = proy_emp_vivos, color = "hombres"),
            size = 1) +
  geom_line(
    data = proy_mujeres,
    aes(x = año, y = proy_emp_vivas, color = "mujeres"),
    size = 1
  ) +
  scale_color_manual(
    values = c(
  ...
  labs(
    x = "Año",
    y = "Personas",
    title = "Proyección Demográfica empleados activos",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = 'bottom')
...
ggplot() +
  geom_line(data = proy_hombres,
            aes(x = año, y = proy_pen_vivos, color = "hombres"),
            size = 1) +
  geom_line(
    data = proy_mujeres,
    aes(x = año, y = proy_pen_vivas, color = "mujeres"),
    size = 1
  ) +
  scale_color_manual(
    values = c(
  ...
  labs(
    x = "Año",
    y = "Personas",
    title = "Proyección Demográfica pensionados",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = 'bottom')
...
ggplot() +
  geom_line(data = proy_hombres,
            aes(x = año, y = proy_emp_muertos, color = "hombres"),
            size = 1) +
  geom_line(
    data = proy_mujeres,
    aes(x = año, y = proy_emp_muertas, color = "mujeres"),
    size = 1
  ) +
  scale_color_manual(
    values = c(
  ...
  labs(
    x = "Año",
    y = "Personas",
    title = "Proyección Demográfica muerte de empleados",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = 'bottom')
...
ggplot() +
  geom_line(data = proy_hombres,
            aes(x = año, y = proy_pen_muertos, color = "hombres"),
            size = 1) +
  geom_line(
    data = proy_mujeres,
    aes(x = año, y = proy_pen_muertas, color = "mujeres"),
    size = 1
  ) +
  scale_color_manual(
    values = c(
  ...
  labs(
    x = "Año",
    y = "Personas",
    title = "Proyección Demográfica muertes de pensionados",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = 'bottom')
...
proy_emp_vp <- function(df){
  ...
  for (i in 1:100){
    col[102-i] <- (col[102-i]-
                     col[101-i])*5000000*(1.03/1.07)^(100-i)
...
### Observaciones
```{r}
proy_H_fin <- data.frame(Año = 2024:2124)
proy_M_fin <- data.frame(Año = 2024:2124)
...
## Proyección financiera de los pagos de beneficio  de pensionado
...
proy_ann_vp <- function(df){
  ...
  for (i in 1:100){
    # Desacumular
    muertos[102-i] <- (muertos[102-i] - muertos[101-i])
  }
  interes <- 1.07^(1/12) - 1
  ...
  for (i in 1:100){
    acum <- 0
    # Caso muerte en un mes predeterminado
    for(m in 1:11){
      acum <- acum + (12 - m)*300000*m*muertos[i+1]*k^m/12
    }
    
    # Caso vive o sobrevive hasta el pago del aguinaldo
    col[i+1] <- (acum  + (col[i+1]+muertos[i+1]/12)*VP) *(1.03/1.07)^(i-1)
...
proy_ann_fin <- function(df){
  ...
  for (i in 1:100){
    ...
    # Caso muerte en un mes predeterminado
    for(m in 1:11){
      acum <- acum + (12 - m)*300000*m*muertos[i+1]/12
    }
    #13*300 000= 3 900 000
    col[i+1] <- (acum  + (col[i+1]+muertos[i+1]/12)*3900000) *(1.03)^(i-1)
...
```{r}
ggplot() +
  geom_line(data = proy_H_fin,
            aes(x = Año, y = proy_emp_vp/1000000, color = "hombres"),
            size = 1) +
  scale_color_manual(
    values = c(
      "hombres" = "royalblue"
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Beneficios de muerte empleados activos hombres (vp)",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = "none")
...
```{r}
ggplot() +
  geom_line(data = proy_M_fin,
            aes(x = Año, y = proy_emp_vp/1000000, color = "mujeres"),
            size = 1) +
  scale_color_manual(
    values = c(
      "mujeres" = "#7a0177"
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Beneficios de muerte empleados activos mujeres (vp)",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = "none")
...
ggplot() +
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Proyección de beneficios de muerte de empleados (vp)",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = 'bottom')
...
ggplot() +
  geom_line(data = proy_H_fin,
            aes(x = Año, y = proy_emp_fin/1000000, color = "hombres"),
            size = 1) +
  scale_color_manual(
    values = c(
      "hombres" = "royalblue"
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Beneficios de muerte empleados activos hombres"
  ) +
  theme_minimal() +
  theme(legend.position = 'none')
```
...
ggplot() +
  geom_line(data = proy_M_fin,
            aes(x = Año, y = proy_emp_fin/1000000, color = "mujeres"),
            size = 1) +
  scale_color_manual(
    values = c(
      "mujeres" = "#7a0177"
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Beneficios de muerte empleados activos mujeres",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = "none")
...
ggplot() +
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Proyección de beneficios de muerte de empleados",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = 'bottom')
...
ggplot() +
  geom_line(data = proy_H_fin,
            aes(x = Año, y = proy_pen_vp/1000000, color = "hombres"),
            size = 1) +
  scale_color_manual(
    values = c(
      "hombres" = "royalblue"
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Beneficios de muerte pensionados hombres (vp)",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = 'none')
...
ggplot() +
  geom_line(data = proy_M_fin,
            aes(x = Año, y = proy_pen_vp/1000000, color = "mujeres"),
            size = 1) +
  scale_color_manual(
    values = c(
      "mujeres" = "#7a0177"
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Beneficios de muerte pensionados mujeres (vp)",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = "none")
...
ggplot() +
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Proyección de beneficios de muerte de pensionados (vp)",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = 'bottom')
...
ggplot() +
  geom_line(data = proy_H_fin,
            aes(x = Año, y = proy_pen_fin/1000000, color = "hombres"),
            size = 1) +
  scale_color_manual(
    values = c(
      "hombres" = "royalblue"
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Beneficios de muerte pensionados hombres",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = 'none')
...
ggplot() +
  geom_line(data = proy_M_fin,
            aes(x = Año, y = proy_pen_fin/1000000, color = "mujeres"),
            size = 1) +
  scale_color_manual(
    values = c(
      "mujeres" = "#7a0177"
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Beneficios de muerte pensionados mujeres",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = "none")
...
ggplot() +
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Proyección de beneficios de muerte de pensionados",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = 'bottom')
...
ggplot() +
  geom_line(data = proy_H_fin,
            aes(x = Año, y = proy_ann_vp/1000000, color = "hombres"),
            size = 1) +
  scale_color_manual(
    values = c(
      "hombres" = "royalblue"
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Pagos anualidades hombres (vp)",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = 'none')
...
ggplot() +
  geom_line(data = proy_M_fin,
            aes(x = Año, y = proy_ann_vp/1000000, color = "mujeres"),
            size = 1) +
  scale_color_manual(
    values = c(
      "mujeres" = "#7a0177"
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Pago anualidades mujeres (vp)",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = "none")
...
ggplot() +
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Proyección de pagos de anualidades (vp)",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = 'bottom')
...
ggplot() +
  geom_line(data = proy_H_fin,
            aes(x = Año, y = proy_ann_fin/1000000, color = "hombres"),
            size = 1) +
  scale_color_manual(
    values = c(
      "hombres" = "royalblue"
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Pago anualidades hombres",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = 'none')
...
ggplot() +
  geom_line(data = proy_M_fin,
            aes(x = Año, y = proy_ann_fin/1000000, color = "mujeres"),
            size = 1) +
  scale_color_manual(
    values = c(
      "mujeres" = "#7a0177"
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Pago anualidades mujeres",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = "none")
...
ggplot() +
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Proyección de pagos de anualidades",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = 'bottom')
...
ggplot() +
  ...
  labs(
    x = "Año",
    y = "Monto (millones)",
    title = "Proyección financiera por sexo, en millones",
    color = "Sexo"
  ) +
  theme_minimal() +
  theme(legend.position = 'bottom')
...
primas <- function(qx){
  ...
  for (i in 1:500){
    ...
    for (j in 1:length(x[[1]])) {
      ...
      if (j + x[[3]] <= 65){
        # Cálculo de las anualidades de primas
        ann_primas<-ann_primas + px_acum*(1.03/1.07)^(j-1)
        ...
        k <- 1/(1+interes) # V mensual
        acum <- 0
        # Caso muerte en un mes predeterminado
        for(m in 1:11){
          acum <- acum + (12 - m)*300000*m*px_acum *(1 - x[[1]][[j]])*k^m/12
        }
        
        # Se suman los valores presentes por el caso de que viva o muera
        vp_pen <- vp_pen + 
          (acum + (px_acum *(x[[1]][[j]] + (1 - x[[1]][[j]])/12))*VP)*(1.03/1.07)^(j-1)
      }
...
La prima nivelada entonces da 1.28 millones de colones anuales aproximadamente, o 106 mil colones al mes.
  ...
  for (i in 1:500){
    ...
    for (j in 1:length(x[[1]])) {
      ...
      if (j + x[[3]] <= 65){
        ...
        # Caso muerte en un mes predeterminado
        for(m in 1:11){
          acum <- acum + (12 - m)*m_p*m*px_acum *(1 - x[[1]][[j]])*k^m/12
        }
...
## Preparativos para acelerar el proceso
```{r}
      ...
      if(vivos[c] == 1){
        if(runif(1) > df[[c]][[1]][[i]]){
          ...
          if(pen[c] == 1){
            ...
            mes <- floor(12*runif(1))+1
            if(mes != 12){
              suma_vp[c] <- suma_vp[c] + (12 - mes)*300000*mes*dif*k^mes/12
            } else {
              suma_vp[c] <- suma_vp[c] + pen[c]*vivos[c]*VP*dif/12
            }
          } else {
...
# write.csv(datos_sim,"res/simulaciones.csv")
```

## Revertir el cambio e importar los datos
```{r}
datos_sim <- read_csv("res/simulaciones.csv", show_col_types = FALSE) %>% select(-`...1`)
```
...
ggplot() +
  ...
  scale_color_manual(
    values = c(
      "determinístico" = "hotpink",
      "estocástico - per50" = "purple4",
      "estocástico - per90" = "lightgreen"
    )
  ) +
  labs(
    x = "Edad",
...
ggplot() +
  ...
  labs(
    x = "Edad",
    y = "Monto",
    title = "Diferencias en las primas, para hombres entre 20 y 65 años",
    color = "Tipo de prima"
  ) +
  theme_minimal() +
  theme(legend.position = 'bottom') +
...
## Funcion de primas con parámetros de inflación y tasa nominal
```{r}
primas_sens <- function(qx, inflacion, tasa_nominal){
  c <- 1
  df = data.frame(edad = numeric(500), sexo = numeric(500), prima = numeric(500))
  ...
  for (i in 1:500){
    ...
    for (j in 1:length(x[[1]])) {
      ...
      if (j + x[[3]] <= 65){
        # Cálculo de las anualidades de primas
        ann_primas<-ann_primas + px_acum*(inflacion/tasa_nominal)^(j-1)
        
        # Calculamos el vp del seguro de empleado activo
        vp_pen <- vp_pen + px_acum *(1 - x[[1]][[j]])*5000000*(inflacion/tasa_nominal)^(j-1)
      } else {
        #Si tiene mas de 65 le calculamos la pensión y el seguro de muerte de pensionado
        
        
        interes <- tasa_nominal^(1/12) - 1
        # se hace el supuesto que paga la primera pensión al final de mes 
        VP_ann <- 300000*(1-(1/tasa_nominal))/interes
        VP_agui <- 300000*(1/tasa_nominal) # modificación - aguinaldo a final de año
        VP <- VP_ann + VP_agui
        vp_pen <- vp_pen + px_acum *(1 - x[[1]][[j]])*1000000*(inflacion/tasa_nominal)^(j-1)
        k <- 1/(1+interes) # V mensual
        acum <- 0
        # Caso muerte en un mes predeterminado
        for(m in 1:11){
        ...
        # Se suman los valores presentes por el caso de que viva o muera
        vp_pen <- vp_pen + 
          (acum + (px_acum *(x[[1]][[j]] + (1 - x[[1]][[j]])/12))*VP)*(inflacion/tasa_nominal)^(j-1)
      }
...
##Analisis de inflación al 2 y rendimientos al 3
```{r}
#primas
primas_anuales_1 <- primas_sens(qx, 1.02, 1.05)

#primas niveladas
suma_vp1<-sum(primas_anuales_1$vp)
suma_ann1<-sum(primas_anuales_1$anualidad)
prima_nivelada_1 <- suma_vp1/suma_ann1
print(prima_nivelada_1)
```

##Anális de inflacion al 3 y rendimientos al 3
```{r}
#primas
primas_anuales_2 <- primas_sens(qx, 1.03, 1.06)

#primas niveladas
suma_vp2<-sum(primas_anuales_2$vp)
suma_ann2<-sum(primas_anuales_2$anualidad)
prima_nivelada_2 <- suma_vp2/suma_ann2
print(prima_nivelada_2)
```

##Anális de inflacion al 4 y rendimientos al 3
```{r}
#primas
primas_anuales_3 <- primas_sens(qx, 1.04, 1.07)

#primas niveladas
suma_vp3<-sum(primas_anuales_3$vp)
suma_ann3<-sum(primas_anuales_3$anualidad)
prima_nivelada_3 <- suma_vp3/suma_ann3
print(prima_nivelada_3)
```

##Análisis de inflación al 2 y rendimientos al 4
```{r}
#primas
primas_anuales_4 <- primas_sens(qx, 1.02, 1.06)

#primas niveladas
suma_vp4<-sum(primas_anuales_4$vp)
suma_ann4<-sum(primas_anuales_4$anualidad)
prima_nivelada_4 <- suma_vp4/suma_ann4
print(prima_nivelada_4)
```

##Análisis de inflación al 4 y rendimientos al 4
```{r}
#primas
primas_anuales_5 <- primas_sens(qx, 1.04, 1.08)

#primas niveladas
suma_vp5<-sum(primas_anuales_5$vp)
suma_ann5<-sum(primas_anuales_5$anualidad)
prima_nivelada_5 <- suma_vp5/suma_ann5
print(prima_nivelada_5)
```

##Análisis de inflación al 2 y rendimientos al 5
```{r}
#primas
primas_anuales_6 <- primas_sens(qx, 1.02, 1.07)

#primas niveladas
suma_vp6<-sum(primas_anuales_6$vp)
suma_ann6<-sum(primas_anuales_6$anualidad)
prima_nivelada_6 <- suma_vp6/suma_ann6
print(prima_nivelada_6)
```

##Análisis de inflación al 3 y rendimientos al 5
```{r}
#primas
primas_anuales_7 <- primas_sens(qx, 1.03, 1.08)

#primas niveladas
suma_vp7<-sum(primas_anuales_7$vp)
suma_ann7<-sum(primas_anuales_7$anualidad)
prima_nivelada_7 <- suma_vp7/suma_ann7
print(prima_nivelada_7)
```

##Análisis de inflación al 4 y rendimientos al 5
```{r}
#primas
primas_anuales_8 <- primas_sens(qx, 1.04, 1.09)

#primas niveladas
suma_vp8<-sum(primas_anuales_8$vp)
suma_ann8<-sum(primas_anuales_8$anualidad)
prima_nivelada_8 <- suma_vp8/suma_ann8
print(prima_nivelada_8)
```
# Anexos
## Anexos demográficos
```{r}
#Preparamos las tablas finales para hacer los anexos
anexo_mujeres_demografico<-
  proy_mujeres[, c("año", "proy_vivas", "proy_muertas", "proy_emp_vivas" , "proy_pen_vivas", "proy_emp_muertas", "proy_pen_muertas" )]
anexo_hombres_demografico<-
  proy_hombres[, c("año", "proy_vivos", "proy_muertos", "proy_emp_vivos" , "proy_pen_vivos", "proy_emp_muertos", "proy_pen_muertos" )]

#Desacumulamos las muertes hombres
anexo_hombres_demografico$proy_muertos<-c(proy_hombres$proy_muertos[1],
                                          diff(proy_hombres$proy_muertos))

anexo_hombres_demografico$proy_emp_muertos<-c(proy_hombres$proy_emp_muertos[1],
                                          diff(proy_hombres$proy_emp_muertos))

anexo_hombres_demografico$proy_pen_muertos<-c(proy_hombres$proy_pen_muertos[1],
                                          diff(proy_hombres$proy_pen_muertos))


#Desacumulamos la muertes mujeres
anexo_mujeres_demografico$proy_muertas<-c(proy_mujeres$proy_muertas[1],
                                          diff(proy_mujeres$proy_muertas))

anexo_mujeres_demografico$proy_emp_muertas<-c(proy_mujeres$proy_emp_muertas[1],
                                          diff(proy_mujeres$proy_emp_muertas))

anexo_mujeres_demografico$proy_pen_muertas<-c(proy_mujeres$proy_pen_muertas[1],
                                          diff(proy_mujeres$proy_pen_muertas))

#Nos quedamos solo con dos dígitos de decimales
anexo_mujeres_demografico<-round(anexo_mujeres_demografico,2)
anexo_hombres_demografico<-round(anexo_hombres_demografico,2)

#Utilizar únicamente los años que aplican:
anexo_hombres_demografico<-head(anexo_hombres_demografico, 90)
anexo_mujeres_demografico<-head(anexo_mujeres_demografico, 90)

```

## Anexos financieros
```{r}
anexo_fin<-data.frame(año=c(2024:2124),
                      proy_fin_hombres=proy_hombres$valor_fin ,
                      proy_fin_mujeres=proy_mujeres$valor_fin)
anexo_fin<-head(anexo_fin, 90)
anexo_fin<-slice(anexo_fin,-1)
```

## Anexos primas
```{r}
anexo_primas_mujeres<-filter(primas_anuales, sexo==2)
anexo_primas_hombres<-filter(primas_anuales, sexo==1)

anexo_primas_mujeres<-anexo_primas_mujeres[, c("edad", "prima")]
anexo_primas_hombres<-anexo_primas_hombres[, c("edad", "prima")]

percentiles_hombres<-filter(percentiles, sexo==1)
percentiles_mujeres<-filter(percentiles, sexo==2)
percentiles_hombres<-percentiles_hombres[, c("per_50", "per_90")]
percentiles_mujeres<-percentiles_mujeres[, c("per_50", "per_90")]

anexo_primas_mujeres<-cbind(anexo_primas_mujeres, percentiles_mujeres)
anexo_primas_hombres<-cbind(anexo_primas_hombres, percentiles_hombres)
anexo_primas_hombres<-round(anexo_primas_hombres,0)
anexo_primas_mujeres<-round(anexo_primas_mujeres,0)
```

## convertir a csv
```{r}
write.csv(anexo_mujeres_demografico,"res/demografico_mujeres.csv")
write.csv(anexo_hombres_demografico,"res/demografico_hombres.csv")

write.csv(anexo_fin,"res/proy_financieras.csv")

write.csv(anexo_primas_hombres,"res/primas_hombres.csv")
write.csv(anexo_primas_mujeres,"res/primas_mujeres.csv")
```
