...
ggplot(data=tabla_rangos_porcentaje_sexo, aes(x=rango_edad, y=frecuencia, fill=sexo)) +
...
```{r}
ABC[ABC$Sexo == 'Hombres',]$Sexo <- 1 #hombres: 1
ABC[ABC$Sexo == 'Mujeres',]$Sexo <- 2#Mujeres: 2
...
proy_ann_vp <- function(df){
  ...
  # se hace el supuesto que empieza a inflarse el monto después del primer pago, además de trae a valor presente a partir del segundo año (el primer año ya se trae a valor presente mediante el uso de la anualidad a:12)
  return(col)
}
```
